...
export interface Migration {
  up: (connection: Connection, callback: (err?: Error) => void) => void;
  down: (connection: Connection, callback: (err?: Error) => void) => void;
}
...
const migration: Migration = {
   ...
   */
  up: function(connection: Connection, callback: (err?: Error) => void) {
          ...
          connection.query(createUsersTable, (err) => {
            ...
            connection.query(insertThreads, (err) => {
              ...
              const insertPosts = `
                ...
                (3, 'Prof. James Chen', '2023-05-18 10:22:00', 'Yes, we\'ve implemented several geothermal systems in Alaska. The key is using antifreeze solutions in ground loop and ensuring proper insulation. We typically see a 15-20% efficiency reduction compared to temperate climates, but systems remain economically viable.')
              `;
   ...
   * @param callback - Callback function
   */
  down: function(connection: Connection, callback: (err?: Error) => void) {
